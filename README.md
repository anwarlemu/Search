...
`Tab` walks along the row of tabs; `esc` puts away whatever is open. Every key above can be changed in Settings › Shortcuts, and a key of your own can open a page.
